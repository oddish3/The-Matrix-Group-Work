...
for (i in 1:5000) {
  ...
  v = mvrnorm(n, c(0,0), Omega,) #c(0,0) is mean of error terms
  ...
  x = z %*% Pi + w # t(zi) does not work here.
...
for (i in 1:5000) {
  ...
  # Define v vector (n x 2)
  v2 = mvrnorm(n, c(0,0), Omega2,) #c(0,0) is mean of error terms
  ...
  x2 = z2 %*% Pi2 + w2 # t(zi) does not work here.
...
for (i in 1:5000) {
  ...
  # Define v vector (n x 2)
  v3 = mvrnorm(n, c(0,0), Omega3,) #c(0,0) is mean of error terms
  ...
  x3 = z3 %*% Pi3 + w3 # t(zi) does not work here.
...
for (i in 1:5000) {
  ...
  # Define v vector (n x 2)
  v4 = mvrnorm(n, c(0,0), Omega3,) #c(0,0) is mean of error terms
  ...
  x4 = z4 %*% Pi4 + w4 # t(zi) does not work here.
